...
export const authApi = { login: (credentials) => api.post('/auth/login', credentials), adminRegister: (details) => api.post('/auth/admin/register', details), me: () => api.get('/auth/me') };
...
export const attendeeApi = { register: (details) => api.post('/attendees/register', details), create: (details) => api.post('/attendees', details), me: () => api.get('/attendees/me'), list: (params) => api.get('/attendees', { params }), getById: (attendeeId) => api.get(`/attendees/${encodeURIComponent(attendeeId)}`) };
